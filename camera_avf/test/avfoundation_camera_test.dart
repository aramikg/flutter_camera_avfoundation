...
import 'package:camera_avf/src/avfoundation_camera.dart';
import 'package:camera_avf/src/utils.dart';
...
const String _channelName = 'plugins.flutter.io/camera_avf';
  ...
  group('Function Tests', () {
    ...
    test('Should set the description while recording', () async {
      ...
      const CameraDescription camera2Description = CameraDescription(
          name: 'Test2', lensDirection: CameraLensDirection.front, sensorOrientation: 0);
