...
const MethodChannel _channel = MethodChannel('plugins.flutter.io/camera_avf');
...
class AVFoundationCamera extends CameraPlatform {
  ...
  /// sent on.
  @visibleForTesting
  static const String deviceEventChannelName = 'plugins.flutter.io/camera_avf/fromPlatform';
  ...
  Future<void> initializeCamera(
    ...
    _channels.putIfAbsent(cameraId, () {
      final MethodChannel channel = MethodChannel('plugins.flutter.io/camera_avf/camera$cameraId');
  ...
  void _startStreamListener() {
    const EventChannel cameraEventChannel =
        EventChannel('plugins.flutter.io/camera_avf/imageStream');
